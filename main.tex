...
Where:
\begin{itemize}[label=]
    \item $Q$: is the heat generated by the heating wire and thus the energy absorbed by ice
    \item $V$: is the voltage of the circuit 
    \item $R$: is the resistance of the wire 
    \item $t$: is the amount of time that the circuit has been generating heat
    \item $Delta T: is the change of temperature of the ice 
    \item $m$: is the mass of the ice that is melt by the wire 
    \item $rho$: is the density of ice 
    \item $V$: is the volume of the ice that is melt by the wire
    \item $s$: is the upper surface of the drill (an annulus)
    \item $d$: is the distance that the drill has traveled through the ice 
\end {itemize}
